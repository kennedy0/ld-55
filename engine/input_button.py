...
class InputButton:
    ...
    @key.setter
    def key(self, value: Optional[int]) -> None:
    ...
    @property
    def mouse_button(self) -> Optional[int]:
        """ The button on the mouse that is mapped to this button. """
        return self._mouse_button

    @mouse_button.setter
    def mouse_button(self, value: Optional[int]) -> None:
