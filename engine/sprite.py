...
from engine.data_types.pivot import Pivot
...
class Sprite:
    ...
    def __init__(self, content_path: str) -> None:
        ...
        # Callbacks
        Window.add_resize_callback(self._reset_flash_texture)
    ...
    @classmethod
    def from_atlas(cls, content_path: str, sprite_name: str) -> Self:
    ...
    @classmethod
    def from_frame(cls, content_path: str, frame: Frame) -> Self:
    ...
    def empty(cls) -> Self:
        ...
        return cls("empty-texture")

    def is_empty(self) -> bool:
        """ Check if this is an empty sprite with no texture. """
        return self.name == "empty-texture"
