...
class Entity:
    ...
    def z_depth(self) -> int:
        """ The Z-depth determines the order that the entity is drawn.
    ...
    @z_depth.setter
    def z_depth(self, value: int) -> None:
        if self.scene:
    ...
    def find(self, entity_name: str) -> Optional[Entity]:
    ...
    def _mouse_post_update(self) -> None:
        ...
        if self.mouse_collisions_enabled and Mouse.in_bounds():
