...
class Controller:
    ...
    @classmethod
    def active_controller(cls) -> Optional[GameController]:
        """ Get the active game controller. """
        return InputManager.get_active_controller()

    @classmethod
    def get_button(cls, button: int, controller_id: Optional[int] = None) -> bool:
    ...
    @classmethod
    def get_button_down(cls, button: int, controller_id: Optional[int] = None) -> bool:
    ...
    @classmethod
    def get_button_up(cls, button: int, controller_id: Optional[int] = None) -> bool:
    ...
    @classmethod
    def get_axis_left_x(cls, controller_id: Optional[int] = None) -> float:
    ...
    @classmethod
    def get_axis_left_y(cls, controller_id: Optional[int] = None) -> float:
    ...
    @classmethod
    def get_axis_right_x(cls, controller_id: Optional[int] = None) -> float:
    ...
    @classmethod
    def get_axis_right_y(cls, controller_id: Optional[int] = None) -> float:
    ...
    @classmethod
    def get_left_analog_stick(cls, controller_id: Optional[int] = None) -> Vector2:
    ...
    @classmethod
    def get_right_analog_stick(cls, controller_id: Optional[int] = None) -> Vector2:
    ...
    @classmethod
    def get_left_trigger(cls, controller_id: Optional[int] = None) -> float:
    ...
    @classmethod
    def get_right_trigger(cls, controller_id: Optional[int] = None) -> float:
    ...
    @staticmethod
    def _get_controller(controller_id: Optional[int] = None) -> Optional[GameController]:
