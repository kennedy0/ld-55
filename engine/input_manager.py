...
if TYPE_CHECKING:
    from engine.input_button import InputButton
...
class InputManager:
    ...
    __active_controller_id: Optional[int] = None
    ...
    def get_keys_pressed(cls) -> tuple[int]:
        ...
        return tuple(cls.__keys)

    @classmethod
    def get_mouse(cls, mouse_button: int) -> bool:
        """ Check if a mouse button is pressed. """
        return mouse_button in cls.__mouse_buttons
    ...
    @classmethod
    def map_key_to_input_button(cls, key: Optional[int], button_name: str) -> None:
        """ Map a key on the keyboard to an Input button. """
        cls.__input_buttons[button_name].key = key

    @classmethod
    def map_mouse_button_to_input_button(cls, mouse_button: Optional[int], button_name: str) -> None:
        """ Map a mouse button to an Input button. """
        cls.__input_buttons[button_name].mouse_button = mouse_button

    @classmethod
    def map_controller_button_to_input_button(cls, controller_button: Optional[int], button_name: str) -> None:
        """ Map a controller button to an Input button. """
        cls.__input_buttons[button_name].controller_button = controller_button

    @classmethod
    def map_controller_axis_to_input_button(cls, axis: Optional[int], direction: int, button_name: str) -> None:
        """ Map a controller button to an Input button.
        'direction' determines whether the positive or negative axis direction is used, and should be either -1 or 1.
        """
